...
async function renderFoodDiary() {
  ...
  const kindInfo = { food:["🍎","Food"], meal:["🍱","Meal"], snack:["🥨","Snack"], condiment:["🧂","Condiment"], drink:["🥤","Drink"] };
