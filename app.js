...
const APP = { name: "More than Measured", version: "0.8.27", schemaVersion: 3 };
...
function openMethylatedProductsGuide(){
  const products=[
    ...
    ["Liquid options","JoySpring MethylBee","A flavored liquid focused on active folate, B12, and B6. Verify the minimum age, serving amount, total micrograms/milligrams, and other ingredients on the current bottle.","https://www.joyspringvitamins.com/"],
    ["Liquid options","MaryRuth's toddler multivitamins","MaryRuth's sells several toddler liquids, drops, and gummies with different formulas. Product names are easy to confuse, so use the exact Supplement Facts panel rather than assuming every product contains methylfolate or methylcobalamin.","https://www.maryruthorganics.com/collections/toddler-health"],
    ["Liquid options","Mama Bird / Best Nest children's multivitamins","Liquid or chewable products may use active folate and B12 forms, but formulas and age ranges vary. Confirm the exact product and current label.","https://www.bestnestwellness.com/collections/children"],
