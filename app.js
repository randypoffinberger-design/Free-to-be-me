...
const APP = { name: "More than Measured", version: "0.8.7", schemaVersion: 3 };
...
async function renderFoodDiary() {
  ...
  const kindInfo = { food:["🍎","Food"], meal:["🍽️","Meal"], snack:[snackIcon,"Snack"], condiment:[condimentIcon,"Condiment"], drink:["🥤","Drink"] };
